...
class NetworkHelper {
  static Future<Uri> setApi(String endPoint) async {
    String lang = await CashHelper.getSavedString("lang", "en");
      return Uri.parse("https://alshiaka.com/${endPoint}consumer_key=ck_0aa636e54b329a08b5328b7d32ffe86f3efd8cbe&consumer_secret=cs_7e2c98933686d9859a318365364d0c7c085e557b&lang=$lang");
  }
